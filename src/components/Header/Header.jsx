...
export default function Header() {
  ...
  return (
    <header className="flex justify-between">
      ...
      <nav className="bg-red fixed bottom-0 z-0 flex h-[88px] w-full justify-around backdrop-blur-[100px] md:top-0 md:justify-center">
        <Link
          href="/"
      ...
      <div className="fixed h-[80px] w-full backdrop-blur-[100px] md:hidden"></div>
